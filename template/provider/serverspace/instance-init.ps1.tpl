...
Set-DnsClientServerAddress -InterfaceAlias "Ethernet_01" -ServerAddresses 8.8.8.8
...
$app = Get-WmiObject -Class Win32_Product | Where-Object { $_.Name -match "Cloudbase*" }
$app.Uninstall()
